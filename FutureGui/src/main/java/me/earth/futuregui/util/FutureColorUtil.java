...
public class FutureColorUtil {
    ...
    public static void glColor(DrawContext context, Color color) {
        context.setShaderColor((color.getRed() / 255.0f), (color.getGreen() / 255.0f), (color.getBlue() / 255.0f), (color.getAlpha() / 255.0f));
    }
