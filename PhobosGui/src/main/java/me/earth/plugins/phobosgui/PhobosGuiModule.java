...
public class PhobosGuiModule extends Module
{
    ...
    public Setting<Boolean> colorSync =
            register(new BooleanSetting("Sync", true));
    public Setting<Boolean> outline =
            register(new BooleanSetting("Outline", false));
    public Setting<Boolean> rainbowRolling =
            register(new BooleanSetting("RollingRainbow", true));
    public Setting<Integer> hoverAlpha =
            register(new NumberSetting<>("Alpha", 180, 0, 255));
    public Setting<Integer> alpha =
            register(new NumberSetting<>("HoverAlpha", 240, 0, 255));
    public Setting<Boolean> openCloseChange =
            register(new BooleanSetting("Open/Close", true));
    ...
    public Setting<String> moduleButton =
            register(new StringSetting("Buttons:", ""));
    public Setting<Boolean> devSettings =
            register(new BooleanSetting("DevSettings", true));
    public Setting<Integer> topRed =
            register(new NumberSetting<>("TopRed", 255, 0, 255));
    public Setting<Integer> topGreen =
            register(new NumberSetting<>("TopGreen", 0, 0, 255));
    public Setting<Integer> topBlue =
            register(new NumberSetting<>("TopBlue", 0, 0, 255));
    public Setting<Integer> topAlpha =
            register(new NumberSetting<>("TopAlpha", 255, 0, 255));
    public Setting<Integer> factor =
            register(new NumberSetting<>("Factor", 1, 0, 20));
    public Setting<Integer> rainbowSpeed =
            register(new NumberSetting<>("RSpeed", 20, 0, 100));
    public Setting<Integer> rainbowSaturation =
            register(new NumberSetting<>("Saturation", 255, 0, 255));
    public Setting<Integer> rainbowBrightness =
            register(new NumberSetting<>("Brightness", 255, 0, 255));
