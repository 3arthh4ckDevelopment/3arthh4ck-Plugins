...
public class Button extends Item
{
    ...
    {
        FutureRenderUtil.drawRect(x, y, x + width, y + height, getState() ? (!isHovering(mouseX, mouseY) ? FutureColorUtil.getClientColorCustomAlpha(240) : FutureColorUtil.getClientColorCustomAlpha(215)) : (!isHovering(mouseX, mouseY) ? FutureColorUtil.getClientColorCustomAlpha(60) : FutureColorUtil.getClientColorCustomAlpha(130)));
