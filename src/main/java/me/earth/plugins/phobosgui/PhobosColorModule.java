...
public class PhobosColorModule extends Module
{
    ...
    public Setting<Boolean> rainbow =
            register(new BooleanSetting("Rainbow", true));
    public Setting<Integer> rainbowSpeed =
            register(new NumberSetting<>("Speed", 80, 0, 100));
    ...
    public Setting<Integer> red =
            register(new NumberSetting<>("Red", 255, 0, 255));
    public Setting<Integer> green =
            register(new NumberSetting<>("Green", 255, 0, 255));
    public Setting<Integer> blue =
            register(new NumberSetting<>("Blue", 255, 0, 255));
    public Setting<Integer> alpha =
            register(new NumberSetting<>("Alpha", 255, 0, 255));
